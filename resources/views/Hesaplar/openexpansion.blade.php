...
India
  ...
  <tbody>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_Adi');?></th>
      <td>{{$items["projedetay"]["data"][0]["adi"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_Aciklama');?></th>
      <td>{{$items["projedetay"]["data"][0]["aciklama"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_HeaterType');?></th>
      <td>{{$items["projedetay"]["data"][0]["HeaterType"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_WaterHeat');?></th>
      <td>{{$items["projedetay"]["data"][0]["WaterHeat"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_Kazankapasitesi');?></th>
      <td>{{$items["projedetay"]["data"][0]["BoilerCapacity"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_Expansion');?></th>
      <td>{{$items["projedetay"]["data"][0]["Expansion"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_WaterExpansion');?></th>
      <td>{{$items["projedetay"]["data"][0]["WaterExpansion"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_WaterVolume');?></th>
      <td>{{$items["projedetay"]["data"][0]["WaterVolume"]}}</td>

    </tr><tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_TankVolume');?></th>
      <td>{{$items["projedetay"]["data"][0]["TankVolume"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_DiameterG');?></th>
      <td>{{$items["projedetay"]["data"][0]["DiameterG"]}}</td>

    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_DiameterD');?></th>
      <td>{{$items["projedetay"]["data"][0]["DiameterD"]}}</td>

    </tr><tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_DiameterH');?></th>
      <td>{{$items["projedetay"]["data"][0]["DiameterH"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_DiameterInchG');?></th>
      <td>{{$items["projedetay"]["data"][0]["DiameterInchG"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_DiameterInchD');?></th>
      <td>{{$items["projedetay"]["data"][0]["DiameterInchD"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.OpenExpansionTank_DiameterInchH');?></th>
      <td>{{$items["projedetay"]["data"][0]["DiameterInchH"]}}</td>
