...
India
  ...
  <tbody>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_Adi');?></th>
      <td>{{$items["projedetay"]["data"][0]["adi"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_Aciklama');?></th>
      <td>{{$items["projedetay"]["data"][0]["aciklama"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_Location');?></th>
      <td>{{$items["projedetay"]["data"][0]["Location"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_RainArea');?></th>
      <td>{{$items["projedetay"]["data"][0]["RainArea"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_RoofType');?></th>
      <td>{{$items["projedetay"]["data"][0]["RoofType"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_RainPipe');?></th>
      <td>{{$items["projedetay"]["data"][0]["RainPipe"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_RainAvg');?></th>
      <td> {{$items["projedetay"]["data"][0]["RainAvg"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_UnloadFactor');?></th>
      <td>{{$items["projedetay"]["data"][0]["UnloadFactor"]}}</td>

    </tr><tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_SuddenNeed');?></th>
      <td>{{$items["projedetay"]["data"][0]["SuddenNeed"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_FlowSection');?></th>
      <td>{{$items["projedetay"]["data"][0]["FlowSection"]}}</td>

    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Rainwater_ColumnDiameter');?></th>
      <td>{{$items["projedetay"]["data"][0]["ColumnDiameter"]}}</td>
