...
India
  ...
  <tbody>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_Adi');?></th>
      <td>{{$items["projedetay"]["data"][0]["adi"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_Aciklama');?></th>
      <td>{{$items["projedetay"]["data"][0]["aciklama"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_WaterRegime');?></th>
      <td> {{$items["projedetay"]["data"][0]["WaterRegime"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_CollectorCapacity');?></th>
      <td>{{$items["projedetay"]["data"][0]["CollectorCapacity"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_TempratureAvg');?></th>
      <td>{{$items["projedetay"]["data"][0]["TempratureAvg"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_TransferorWater');?></th>
      <td>{{$items["projedetay"]["data"][0]["TransferorWater"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_SpecificHeat');?></th>
      <td>  {{$items["projedetay"]["data"][0]["SpecificHeat"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_Density');?></th>
      <td>{{$items["projedetay"]["data"][0]["Density"]}}</td>

    </tr><tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_UsingConcurrentFactor');?></th>
      <td>{{$items["projedetay"]["data"][0]["UsingConcurrentFactor"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_HydrophoreFactor');?></th>
      <td>{{$items["projedetay"]["data"][0]["HydrophoreFactor"]}}</td>

    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_Adet');?></th>
      <td>{{$items["projedetay"]["data"][0]["Piece"]}}</td>

    </tr><tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_WaterSpeed');?></th>
      <td>{{$items["projedetay"]["data"][0]["WaterSpeed"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_CollectorFlow');?></th>
      <td>{{$items["projedetay"]["data"][0]["CollectorFlow"]}}</td>

    </tr>
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_CollectorDiameter');?></th>
      <td>{{$items["projedetay"]["data"][0]["CollectorDiameter"]}}</td>

    </tr>
  
    <tr class="simple">
      <th scope="row"><?=__('staticmessage.Collector_CollectorInch');?></th>
      <td>{{$items["projedetay"]["data"][0]["CollectorInch"]}}</td>
