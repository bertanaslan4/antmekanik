                ...
                <div class="wrap d-md-flex">
                    <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                        <div class="text w-100">
                            ...
                            <h2 class="heading-section">Ant Mekanik </h2>
                        </div>
                    </div>
                    <div class="login-wrap p-4 p-lg-5">
                        ...
                        <form action="{{route('admin.post.register')}}" class="signin-form" method="post">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <label class="label" for="password">Sifre Tekrar</label>
                                <input type="password" name="passwordagain"  class="form-control" placeholder="Password Again" required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="label" for="password">Unique ID</label>
                                <input type="text" name="kilit_id"  class="form-control" placeholder="Unique ID" required>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary submit px-3" value="Giriş Yap">Kayıt Ol</button>
                            </div>
                            <div class="form-group d-md-flex">
                                ...
                                <div class="w-50 text-md-right">
                                    <a href="{{route('admin.forgotpass')}}">Sifremi Unuttum</a>
                                </div>
                            </div>
                        </form>
                    </div>
